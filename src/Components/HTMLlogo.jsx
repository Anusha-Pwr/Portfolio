...
Command: npx gltfjsx@6.1.11 HTMLlogo.gltf --transform
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/Portfolio/HTMLlogo-transformed.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[-0.01, 0, 0]} rotation={[-Math.PI / 2, 0.01, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.007}>
          ...
          <mesh geometry={nodes.Plane002_five_0.geometry} material={materials.five} position={[61.85, 307.49, 35.17]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={100} />
        </group>
      </group>
    </group>
  )
