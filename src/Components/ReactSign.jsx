...
Command: npx gltfjsx@6.1.11 ReactSign.gltf --transform
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/Portfolio/ReactSign-transformed.glb')
  return (
...
useGLTF.preload('/ReactSign-transformed.glb')
